...
import { handleOpenBackgroundBlur, handleOpenDiscoveryReviesModal, handleWarningModal } from '../src/store/features/modalReducer';
          ...
          <div style={{ height: '100%' }}>
            <MenuContainer>
              ...
              <div className={styles.rightMenuContainer}>
                {user !== undefined && Object.keys(user).length !== 0 && <DownButon onClick={() => {
              ...
              <div className={styles.discoverRight}>
                {
                  selectedMenu === 'Anime' ?
                    ...
                    <div className={styles.weekAnime}>
                      ...
                      {
                        animeList.movieTheWeeks.map((item, index) => {
                          return index === selectedMangaWeekIndex && item.manga != null && <div
                            style={{ display: 'flex', flexDirection: 'column' }}
                            key={index}>
                            <div className={styles.weekAnimeBody}>
                              ...
                              {
                                user !== undefined && Object.keys(user).length !== 0 ?
                                  <a href={'/manga/' + item.manga.seoUrl}><picture><img alt={item.manga.name} className={styles.leftImage} height="100" width="80" src={item.manga.image} /></picture></a>
                                  :
                                  <div
                                    onClick={() => {
                                      dispatch(handleOpenBackgroundBlur(true));
                                    ...
                                    <picture><img alt={item.manga.name} className={styles.leftImage} height="100" width="80" src={item.manga.image} /></picture>
                                  </div>
                              }
