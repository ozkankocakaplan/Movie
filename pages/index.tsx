          ...
          <div ref={leftTopScroll} className={styles.topEpisodeContainer}>
            {
              type === 'Anime' ?
                ...
                ratingAnimeList.slice(0, 9).map((item, index) => {
                  return <Movie handleOpenModal={() => setMovieInfoShow(true)} type='MODAL' key={index} anime={item} infoContainerLeft='135px' src={baseUrl + item.anime.img} />
                })
                :
                ratingMangaList.length !== 0 &&
                ratingMangaList.slice(0, 9).map((item, index) => {
                  return <Movie type='MODAL' key={index} manga={item} infoContainerLeft='135px' src={baseUrl + item.manga.image} />
                })
            }
          </div>
          <div ref={rightTopScroll} className={styles.newEpisodesContainer}>
            {
              type === 'Anime' ?
                ...
                newEpisodeAnime.map((item, index) => {
                  return <Movie type='LINK' key={index} anime={item} infoContainerLeft='-290px' src={baseUrl + item.img} />
                })
                :
                newEpisodeManga.length !== 0 &&
                newEpisodeManga.map((item, index) => {
                  return <Movie type='LINK' key={index} manga={item} infoContainerLeft='-290px' src={baseUrl + item.image} />
                })
            }
          </div>
        </div>
          ...
          <div ref={leftBottomScroll} className={styles.top2EpisodeContainer}>
            {
              type === 'Anime' ?
                ...
                ratingAnimeList.slice(10, 20).map((item, index) => {
                  return <Movie type='MODAL' key={index} anime={item} infoContainerLeft='135px' src={baseUrl + item.anime.img} />
                })
                :
                ratingMangaList.length !== 0 &&
          ...
          <div ref={rightBottomScroll} className={styles.new2EpisodesContainer}>
            {
              type === 'Anime' ?
                ...
                newEpisodeAnime.slice(10, 20).map((item, index) => {
                  return <Movie type='LINK' key={index} anime={item} infoContainerLeft='135px' src={baseUrl + item.img} />
                })
                :
                newEpisodeManga.length !== 0 &&
                newEpisodeManga.slice(10, 20).map((item, index) => {
                  return <Movie type='LINK' key={index} manga={item} infoContainerLeft='135px' src={baseUrl + item.image} />
                })
            }
          </div>
        </div>
